...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        pickers = {
          find_files = {
            hidden = false, -- for capturing hidden files
          },
        },
        extensions = {
          ['ui-select'] = {
  ...
  },
  {
    ...
    config = function()
      ...
      --  TODO Neovim 0.11+ support: https://github.com/nvim-lua/kickstart.nvim/pull/1475/files
      --  Pull in when updated
